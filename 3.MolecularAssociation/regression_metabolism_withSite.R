...
X <- read.table(paste0('/public/home/pren/MultiOrganAging/data/MetabolicAsso/imputated_median_scaled_bl_intersection_',organ,'Age_original_INT_AgeSexremoved_metabolism.csv'),sep = ',',header=FALSE)
colnames(X)[colnames(X)=='V1'] <- 'eid'
X_orig <- as.matrix(X[,2:dim(X)[2]])
Y <- read.table(paste0('/public/home/pren/MultiOrganAging/data/MetabolicAsso/imputated_median_scaled_bl_metabolism_intersection_',organ,'Age_original.csv'),sep = ',',header=TRUE)
Y_orig <- as.matrix(Y[,2:dim(Y)[2]])
# check if the subjs in same order
X_order <-  read.table(paste0('/public/home/pren/MultiOrganAging/data/MetabolicAsso/imputated_median_scaled_bl_metabolism_intersection_',organ,'Age_original_subjs.csv'),sep = ',',header=TRUE)
Y_order <- read.table(paste0('/public/home/pren/MultiOrganAging/data/MetabolicAsso/imputated_median_scaled_bl_metabolism_intersection_',organ,'Age_original_subjs.csv'),sep = ',',header=TRUE)
...
allSiteInfo <- read.table('/public/home/pren/MultiOrganAging/data/AllSiteInfo.csv', sep=',' ,header=T, check.names=F)
...
agegapNames=organ
MetaNames=read.table('/public/home/pren/MultiOrganAging/data/MetabolicAsso/imputated_Metabolicdata_bl_metaNames.csv', sep = ',', header=TRUE)
...
write.table(tempout,paste0('/public/home/pren/MultiOrganAging/data/MetabolicAsso/association_final',organ,'Data_metabolism.csv'),row.names = F,sep=',')
...
saveRDS(demography_ageGap,paste0('/public/home/pren/MultiOrganAging/data/MetabolicAsso/demography_',organ,'_metabolism.rds'))
...
saveRDS(my_data_list, file = paste('/public/home/pren/MultiOrganAging/data/MetabolicAsso/',prefix,"_result_metabolism.rds",sep=''))
save.image(file = paste('/public/home/pren/MultiOrganAging/data/MetabolicAsso/',prefix,"_environment_metabolism.RData",sep=''))
}
...
for(i in seq(1,length(organs))){
  organ <- organs[i]
  result <- readRDS(paste0('/public/home/pren/MultiOrganAging/data/MetabolicAsso/imputated_median_scaled_bl_intersection_',organ,'_allremoved_result_metabolism.rds'))
  ...
  write.table(temp, paste0('/public/home/pren/MultiOrganAging/data/MetabolicAsso/imputated_median_scaled_bl_intersection_',organ,'_allremoved_result_metabolism_sigResultBeta.csv'),sep=',',row.names = F)
}
